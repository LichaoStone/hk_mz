...
function(e) {
    ...
    t = {
        ...
        get: function(e, i, a) {
            ...
            null === l.content[i] ? "": (n = l.template.repl("{previewId}", o).repl("{frameClass}", " file-preview-initial").repl("{fileindex}", r).repl("{content}", l.content[i]).repl("{footer}", t.footer(e, i, a)), l.tags.length && l.tags[i] && (n = _(n, l.tags[i])), n)
        },
    ...
    p = {
        ...
        //删除class glyphicon-hand-down
        indicatorNew: '<i class="glyphicon  text-warning"></i>',
    ...
    //修改kv-file-upload源码，将之隐藏 style="display:none"
    y = '<button type="button" class="kv-file-upload {uploadClass}" style="display:none" title="{uploadTitle}">   {uploadIcon}\n</button>\n',
    ...
    H.prototype = {
        ...
        listen: function() {
            ...
            i.$container.find(".kv-fileinput-upload").off("click").on("click",
            function(t) {
        ...
        abort: function(i) {
            var t, a = this;
            return a.ajaxAborted && "object" == typeof a.ajaxAborted && void 0 !== a.ajaxAborted.message ? (t = void 0 !== a.ajaxAborted.data ? a.getOutData({},
            a.ajaxAborted.data) : a.getOutData(), t = e.extend(t, i), a.showUploadError(a.ajaxAborted.message, t, "filecustomerror"), !0) : !1
        },
        ...
        initDragDrop: function() {
            ...
            e(document).on("dragenter dragover drop",
            function(e) {
                e.stopPropagation(),
                e.preventDefault()
            })
        ...
        setFileDropZoneTitle: function() {
            ...
            e.isUploadable && e.showPreview && 0 !== i.length && !(e.getFileStack().length > 0) && e.dropZoneEnabled && (0 === i.find(".file-preview-frame").length && i.prepend('<div class="' + e.dropZoneTitleClass + '">' + e.dropZoneTitle + "</div>"), e.$container.removeClass("file-input-new"), o(e.$container, "file-input-ajax-new"))
        },
        ...
        renderFileFooter: function(e, i) {
            ...
            return n.isUploadable ? (t = l.repl("{actions}", n.renderFileActions(!0, !0, !1, !1, !1)), a = t.repl("{caption}", e).repl("{width}", i).repl("{indicator}", r.indicatorNew).repl("{indicatorTitle}", r.indicatorNewTitle)) : a = l.repl("{actions}", "").repl("{caption}", e).repl("{width}", i).repl("{indicator}", "").repl("{indicatorTitle}", ""),
        ...
        clear: function() {
            ...
            0 === a.$container.find(".file-preview-frame").length && (a.initCaption() || a.$captionContainer.find(".kv-caption-icon").hide(), a.setEllipsis()),
            a.hideFileIcon(),
            a.raise("filecleared"),
        ...
        ajaxSubmit: function(i, t, a, n) {
            ...
            r = e.extend({
                ...
                url: l.uploadUrl+'?userKeyForUinon='+userKeyForUinon+'&onlyOneUserLoginFlag='+onlyOneUserLoginFlag,
                type: "POST",
                dataType: "json",
                data: l.formdata,
                cache: !1,
        ...
        uploadSingle: function(i, a, n) {
            ...
            0 === g || !F || C.hasClass("disabled") || m.abort(k) || (s = function() {
                ...
                e.length > 0 || m.fileBatchCompleted || (m.fileBatchCompleted = !0, setTimeout(function() {
                    ...
                    m.hasInitData && (m.initPreview(), m.initPreviewDeletes()),
                    m.setProgress(100),
                    m.unlock(),
                    m.clearFileInput(),
            ...
            c = function() { ! n || 0 === g || m.uploadPercent >= 100 || (m.uploadCount += 1, l = 80 + Math.ceil(20 * m.uploadCount / g), m.uploadPercent = Math.max(l, m.uploadPercent), m.setProgress(m.uploadPercent), m.initPreviewDeletes())
            },
            p = function() {
            ...
            u = function(t) {
                ...
                k = e.extend(k, r),
                m.abort(k) && (t.abort(), m.setProgress(100))
            },
            f = function(t, a, l) {
                r = m.getOutData(l, t),
                k = e.extend(k, r),
        ...
        uploadBatch: function() {
            ...
            0 !== u && f && !c.abort(v) && (i = c.fileActionSettings, t = function(t, a, n) {
            ...
            l = function(i, r, l) {
                ...
                void 0 === i.error || R(i.error) ? (c.raise("filebatchuploadsuccess", [o]), a(), c.showPreview ? (s.find(".kv-file-upload").hide(), s.find(".kv-file-remove").hide(), s.each(function() {
                    ...
                    return n(a),
                    0 === d.length ? void t(a, "indicatorError", "indicatorErrorTitle") : void( - 1 !== e.inArray(a, d) ? t(a, "indicatorError", "indicatorErrorTitle") : (i.find(".kv-file-upload").hide(), i.find(".kv-file-remove").hide(), t(a, "indicatorSuccess", "indicatorSuccessTitle"), c.filestack[a] = void 0))
        ...
        previewDefault: function(i, t, a) {
            if (this.showPreview) {
                ...
                p = "";
                a === !0 && (p = " btn disabled", s += '<div class="file-other-error text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i></div>'),
        ...
        readFiles: function(i) {
            function t(e) {
                if (R(n.attr("multiple")) && (u = 1), e >= u) return a.isUploadable && a.filestack.length > 0 ? a.raise("filebatchselected", [a.getFileStack()]) : a.raise("filebatchselected", [i]),
                ...
                j = R(U) ? "": U.join(", ");
                if (R(U) || ($ = new RegExp("\\.(" + U.join("|") + ")$", "i")), k = k.toFixed(2), a.maxFileSize > 0 && k > a.maxFileSize) return b = a.msgSizeTooLarge.repl("{name}", F).repl("{size}", k).repl("{maxSize}", a.maxFileSize),
                void(a.isError = h(b, E, T, e));
                if (!R(P) && z(P)) {
                    for (w = 0; w < P.length; w += 1) x = P[w],
                    g = f[x],
                    C = void 0 !== g && g(E.type, F),
                    D += R(C) ? 0 : C.length;
                    if (0 === D) return b = a.msgInvalidFileType.repl("{name}", F).repl("{types}", S),
                    void(a.isError = h(b, E, T, e))
                }
        ...
        change: function(i) {
            ...
            if (a.reader = null, a.resetUpload(), a.hideFileIcon(), a.isUploadable && a.$container.find(".file-drop-zone ." + a.dropZoneTitleClass).remove(), c) for (r = []; p[f];) s = p[f],
            s.type || s.size % 4096 !== 0 ? r.push(s) : v++,
            f++;
            else r = void 0 === i.target.files ? i.target && i.target.value ? [{
                name: i.target.value.replace(/^.+\\/, "")
            }] : [] : i.target.files;
            if (R(r) || 0 === r.length) return m || a.clear(),
            a.showFolderError(v),
        ...
        setCaption: function(i, t) {
            var a, n, r = this,
            l = t || !1;
            if (l) a = e("<div>" + r.msgValidationError + "</div>").text(),
        ...
        renderBrowse: function() {
            ...
            '<div style="width:48px;height:32px;" class="' + i + '"' + t + "> " + e.browseIcon + e.browseLabel + " </div>"
        },
        renderRemove: function() {
            var e = this,
            i = e.removeClass + " fileinput-remove fileinput-remove-button",
            t = "";
            return e.showRemove ? (e.isDisabled && (t = " disabled "), '<button type="button" style="height:32px;" title="' + e.removeTitle + '" class="' + i + '"' + t + ">" + e.removeIcon + e.removeLabel + "</button>") : ""
        },
        ...
        renderUpload: function() {
            ...
            t = "",
            a = "";
            return e.showUpload ? (e.isDisabled && (a = " disabled "), t = !e.isUploadable || e.isDisabled ? '<button type="submit" title="' + e.uploadTitle + '"class="' + i + '"' + a + ">" + e.uploadIcon + e.uploadLabel + "</button>": '<a href="' + e.uploadUrl + '" style="height:32px;" title="' + e.uploadTitle + '" class="' + i + '"' + a + ">" + e.uploadIcon + e.uploadLabel + "</a>") : ""
        }
    },
    e.fn.fileinput = function(t) {
        if (n() || i(9)) {
            ...
            this.each(function() {
                ...
                n = i.data("fileinput"),
                r = "object" == typeof t && t;
                n || (n = new H(this, e.extend({},
                e.fn.fileinput.defaults, r, e(this).data())), i.data("fileinput", n)),
    ...
    e.fn.fileinput.defaults = {
        ...
        browseIcon: '<i class="glyphicon glyphicon-folder-open" style="margin-left:3px;"></i> &nbsp;',
