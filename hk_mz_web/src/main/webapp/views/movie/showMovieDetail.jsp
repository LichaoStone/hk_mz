...
<head>
	...
	<script type="text/javascript" src="${basePath}/page/movie/showMovieDetail.js"></script>
	<!--  <link href="${basePath}/page/movie/css/showMovieDetail.css" rel="stylesheet">-->
	<style>
	</style>
</head>
<body>
	<div class="container-fluid containe-update">
		<form id="form" role="form" method="post" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="form-group detail_line-div">
				...
				<span class="display_content_height">${bean.movieName}</span>
			</div>
			<!-- 版权时间 -->
			<div class="form-group detail_line-div">
				<label for="shopName" class="input_title_label">
			...
			<!-- 标签 -->
			<div class="form-group detail_line-div">
				<label for="movieTag" class="input_title_label">
					标签:
				</label>
				<span class="display_content_height" id="movieTag">${bean.movieTag}</span>
			</div>
			<!-- 导演-->
			<div class="form-group detail_line-div">
				<label for="shopName" class="input_title_label">
