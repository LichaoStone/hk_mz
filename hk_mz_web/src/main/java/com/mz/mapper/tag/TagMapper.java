...
public interface TagMapper{
	...
	public long getTagClassCountByQuery(TagVoQuery query);
	/**
	 * 获得tag分类列表
	 * @param query
	 * @return
	 */
	public List<TagVo> getTagClassListByQuery(TagVoQuery query);
	 ...
	 * @return
	 */
	public List<TagVo> getTagLetterListByQuery(TagVoQuery query);
