...
public class XmlParser{
    ...
    /**
     * 
     * @方法功能描述:获取指定父节点下子节点的name属性已经属性值
     */
    public static Map<String,String > getAllChildText(Element ele){
    	Map<String,String > childMap = new HashMap<String,String>();
    	List<Element> propertyElement=getChildList(ele);
    	for(Element proEle:propertyElement){
    		childMap.put(attrValue(proEle,"Name"),proEle.getText().trim());
    	}
    	return childMap;
    }
    //去掉换行符
